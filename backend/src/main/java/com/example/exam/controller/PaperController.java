...
public class PaperController {
    ...
    @com.example.exam.annotation.OperationLog(module = "试卷管理", type = "查询", description = "分页查询试卷", recordParams = false)
    @GetMapping("/page")
    ...
    @com.example.exam.annotation.OperationLog(module = "试卷管理", type = "创建", description = "创建试卷")
    @PostMapping
    ...
    @com.example.exam.annotation.OperationLog(module = "试卷管理", type = "创建", description = "智能组卷")
    @PostMapping("/auto-generate")
    public Result<Long> autoGenerate(
            @Parameter(description = "试卷基本信息", required = true) @RequestBody Paper paper,
            @Parameter(description = "组卷规则列表", required = true) @RequestBody PaperRule[] rules) {
        Long paperId = paperService.autoGeneratePaper(paper, rules);
